...
Map<String,dynamic> _mentOrstud={ };
bool loading =true;
String _name=" ";
String _email=" ";
List _subjects=new List();
List _days = ["everyday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"];
List _choosenDay = List();
List finalDay = List();
Map _topicMap={};
                  ...
                  ListView.builder(
                    ...
                    return title == "Maths"?_topicMap[Maths[index]] == true?GestureDetector(
                      child: ListTile(
                        ...
                        subtitle: ListView.builder(
                            physics: NeverScrollableScrollPhysics(),
                            shrinkWrap: true,
                            itemCount: _mentOrstud[Maths[index]].length,
                            itemBuilder: (context,ind){
                              return Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(finalDay[ind]),
                                  Text(_mentOrstud[Maths[index]][ind])
                                ],
                              );
                            }),
                    ...
                    title =="Science"?_topicMap[Science[index]] == true?ListTile(title: Text(Science[index],),
                        ...
                        subtitle: ListView.builder(
                          physics: NeverScrollableScrollPhysics(),
                          shrinkWrap: true,
                            itemCount: _mentOrstud[Science[index]].length,
                            itemBuilder: (context,ind){
                              return Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(finalDay[ind]),
                                  Text(_mentOrstud[Science[index]][ind])
                                ],
                              );
                            }),
                    ...
                    title =="Social Science"?_topicMap[Social_Science[index]] == true?ListTile(
                        ...
                        subtitle: ListView.builder(
                            physics: NeverScrollableScrollPhysics(),
                            shrinkWrap: true,
                            itemCount: _mentOrstud[Social_Science[index]].length,
                            itemBuilder: (context,ind){
                              return Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(finalDay[ind]),
                                  Text(_mentOrstud[Social_Science[index]][ind])
                                ],
                              );
                            }),
                        trailing: Icon(Icons.videocam,size: 20,),
                    ...
                    title == "English"?_topicMap[English[index]] == true?ListTile(
                        ...
                        subtitle: ListView.builder(
                            physics: NeverScrollableScrollPhysics(),
                            shrinkWrap: true,
                            itemCount: _mentOrstud[English[index]].length,
                            itemBuilder: (context,ind){
                              return Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(finalDay[ind]),
                                  Text(_mentOrstud[English[index]][ind])
                                ],
                              );
                            }),
                    ...
                    _topicMap[French[index]] == true?ListTile(
                        ...
                        subtitle: ListView.builder(
                            physics: NeverScrollableScrollPhysics(),
                            shrinkWrap: true,
                            itemCount: _mentOrstud[French[index]].length,
                            itemBuilder: (context,ind){
                              return Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(finalDay[ind]),
                                  Text(_mentOrstud[French[index]][ind])
                                ],
                              );
                            }),
  ...
  retrievingData(){
    ...
    firestoreInstance.collection("userInfo").doc(firebaseUser.uid).get().then((value){
      ...
      setState(() {
        ...
        _mentOrstud = value.data()["mentOrstud"];
        //print(value.data()["mentOrstud"]);
        _choosenDay = value.data()["days"];
      });
    });
  }
