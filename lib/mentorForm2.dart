...
import 'package:hackathon_project/mentorForm3.dart';
import 'dart:ui';
import 'package:toast/toast.dart';

class mentorForm2 extends StatefulWidget {
  List _list;

  mentorForm2(this._list);
  @override
  _mentorForm2State createState() => _mentorForm2State();
}
...
class _mentorForm2State extends State<mentorForm2>
                ...
                child: GestureDetector(
                  onTap: (){
                    if(logic()){
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => mentorForm3()),
                      );
                    }else{
